...
namespace spdlog::details {
    ...
    void registry::set_levels(log_levels levels, level::level_enum *global_level) {
        ...
        for (auto &logger: loggers_) {
            ...
            if (logger_entry != log_levels_.end()) { logger.second->set_level(logger_entry->second); }
            else if (global_level_requested) { logger.second->set_level(*global_level); }
        }
    }
